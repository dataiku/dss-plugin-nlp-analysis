...
def test_monolingual_category(user_dss_clients):
    """Plugin parameters: -language: en
    - category_column specified"""
    test_scenario(user_dss_clients,"MONOLINGUALCATEGORY")
    dss_scenario.run(
        user_dss_clients,
        project_key=PROJECT_KEY,
        scenario_id="MONOLINGUALCATEGORY",
    )
...
def test_monolingual_no_category(user_dss_clients):
    ...
    dss_scenario.run(
        user_dss_clients,
        project_key=PROJECT_KEY,
        scenario_id="MONOLINGUALNOCATEGORY",
    )
...
def test_multilingual_category(user_dss_clients):
    ...
    dss_scenario.run(
        user_dss_clients,
        project_key=PROJECT_KEY,
        scenario_id="MULTILINGUALCATEGORY",
    )
...
def test_multilingual_no_category(user_dss_clients):
    ...
    dss_scenario.run(
        user_dss_clients,
        project_key=PROJECT_KEY,
        scenario_id="MULTILINGUALNOCATEGORY",
    )
